...
Arvodet för undervisning är två upphöjt till åtta kronor per timme i sal. Arvodet för tentarättning är två upphöjt till sju kr/timme. I beloppen ingår förberedelser och semesterersättning.
...
*  Vissa övningar bygger på att studenterna ska skriva en del av ett program. Detta delprogram kan ju då inte fås att fungera utan fler klasser (som inte finns).
...
[Här](https://github.com/bjornregnell/lth-eda016-2015/tree/master/teachers) finns kommentarer till de enskilda laborationerna i filerna hints-labxx-yyy.md. Dessa kommentarer är inte alls uttömmande -- du får gärna kontakta kursansvarig och ge synpunkter om du tycker att något speciellt saknas. Kom gärna med pull requests!
