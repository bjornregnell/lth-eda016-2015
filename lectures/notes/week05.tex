...
\begin{enumerate} \footnotesize
 ...
 \item Antalet ska lagras i ett tecken och måste rymmas i en \code{char}-variabel (16 bitar).
...
Klasser: \code{Die} (tärning), \code{Player} (spelare), \code{DiceGame} (genomför ett spel).
\end{Slide} 
...
Det blir \href{https://github.com/bjornregnell/lth-eda016-2015/blob/master/lectures/examples/eclipse-ws/lecture-examples/src/week05/BrokenSwitch.java}{tokigt} om man glömmer \Key{break}:
