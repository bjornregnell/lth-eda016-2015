...
Antag att vi hade efter skapandet av våra gurkor gjort:
\begin{lstlisting}
g1 = g2;
\end{lstlisting}
...
\node [right = of g2obj] {Ingen kan någonsin komma åt detta objekt.};
\end{tikzpicture}
...
\item Med \Key{protected} begränsas synligheten till egna paketet och egna subklasser
...
\subsection{Code@LTH event torsdagen den 17 september, 18:00 – 20:00}
\begin{Slide}{Versionshantera din kod och koda öppet med git, GitHub och Bitbucket}\footnotesize
...
\item Registrera er på båda och paxa ditt användarnamn! Använd GitHub för öppna och Bitbucket för stängda repo. 
\item Alla måste genast stjärnmarkera \href{https://github.com/bjornregnell/lth-eda016-2015}{kursens repo} :) 
\end{itemize}
Kom till Code@LTH-eventet om git, GitHub och Bitbucket torsdagen den 17 september, 18:00 – 20:00
\end{Slide}
