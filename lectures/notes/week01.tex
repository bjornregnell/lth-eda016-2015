...
\begin{enumerate}
\item Senast måndag 31/8 kl 20:00, fyll i \url{http://cs.lth.se/eda016/survey}
...
\Emph{Varför?} Så att de som spelar uppmuntras att spela mer :) \\ \vspace{1em}
\Emph{Algoritm:}\footnote{Hittar du buggen?}
\begin{enumerate}
