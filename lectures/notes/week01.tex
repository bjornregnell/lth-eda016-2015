...
\item Kryssa om du ska gå kursen\footnote{Redan gått motsvarande högskolekurs? Ansök då om tillgodoräknande}
\item Kryssa om du har programmerat innan
\item Kryssa om du kan tänka dig att vara kursombud
\end{itemize}
}
