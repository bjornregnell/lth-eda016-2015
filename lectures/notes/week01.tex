...
\item ''Programmeringskompetens'' är inte \textit{en} enda enkel förmåga utan en komplex sammansättning av flera olika förmågor
\item Ett innovativt utvecklarteam behöver många olika kompetenser för att vara framgångsrikt
\end{itemize}
\end{Slide}
