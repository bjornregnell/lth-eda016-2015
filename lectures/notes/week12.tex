...
\Emph{Problem}: Vi har en osorterad sekvens med heltal. Vi vill ordna denna mängd i en sorterad sekvens från minst till störst.
\pause
...
\begin{itemize}
\item Insättningssortering \Emph{lösningsidé}: Ta ett element i taget från den osorterade högen och sätt in det på rätt plats i den sorterade sekvensen och upprepa till det inte finns fler osorterade element. 
\pause
\item Urvalsssortering \Emph{lösningsidé}: Välj ut det minsta kvarvarande element i den osorterade högen och placera det sist i den sorterade sekvensen och upprepa till det inte finns fler osorterade element. 
\end{itemize}
\end{Slide} 
