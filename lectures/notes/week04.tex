...
%\frametitle{Objekt som parameter}
%%\FIXBEFORECODE
%\begin{Spec}
...
%\FIXBEFORECODE\vspace{-2mm}
%\begin{center}
%\includegraphics[scale=1.0]{fkap3/distobjects.pdf}
%\end{center}
%\end{frame} 
%
%\begin{frame}[fragile=singleslide]
%\frametitle{Implementering av \texttt{getDistanceTo}}
%Använd bara metoderna i \texttt{Point}:
%\begin{Code}
...
%\end{Code}
%
%Utnyttja kunskapen om att \texttt{Point} har attributen \texttt{x} och \texttt{y}:
%\begin{Code}
%public double getDistanceTo(Point p) {
%	int xDist = x - p.x;
%	int yDist = y - p.y;
...
%\begin{center}
%\includegraphics[scale=1.0]{fkap3/samelocation.pdf}
%\end{center}
%
%Nu kan man flytta båda kvadraterna med \texttt{loc.move(25,30)}. Men observera att \texttt{sq1.move(25,30)} också medför att båda kvadraterna flyttas!
%\end{frame} 
%
%\begin{frame}[fragile=singleslide]
...
%\end{Code}
%
%\n Man kan skriva en metod som ger \texttt{Point}-objektet som resultat, men då ger man användaren tillgång till en implementeringsdetalj så det brukar man inte göra:
%
%\begin{Code}
